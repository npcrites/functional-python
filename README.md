# Functional Python [![](https://github.com/npcrites/functional-python/workflows/tests/badge.svg)](https://github.com/npcrites/functional-python/actions?query=workflow%3Atests)
